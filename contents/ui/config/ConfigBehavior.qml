...
Item {
    ...
    ColumnLayout {
        ...
        Kirigami.InlineMessage {
            ...
            text: cfg_showAppMenuOnMouseEnter ? i18n("Would you like <b>also to activate</b> that behavior to surrounding Window AppMenu?") : i18n("Would you like <b>also to deactivate</b> that behavior to surrounding Window AppMenu?")
            onShowWindowAppMenuTouchedChanged: {
                if (plasmoid.configuration.containmentType !== 2) {
                    //Latte Containment
                    visible = false;
                    return ;
                }
