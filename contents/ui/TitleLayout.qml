...
GridLayout {
    ...
    property int applicationTextLength: {
        ...
        if (plasmoid.configuration.style === 0 || plasmoid.configuration.style === 2)
            //Application
            //ApplicationTitle
        ...
        var subElements = plasmoid.formFactor === PlasmaCore.Types.Horizontal ? firstSpacer.width + iconLength + midSpacerLength + lastSpacer.width : firstSpacer.height + iconLength + midSpacerLength + lastSpacer.height;
    ...
    Item {
        ...
        Layout.maximumWidth: Layout.minimumWidth
        Layout.minimumHeight: plasmoid.formFactor === PlasmaCore.Types.Horizontal ? root.thickness : iconItem.iconSize
        Layout.maximumHeight: Layout.minimumHeight
    ...
    Item {
        ...
        RowLayout {
            ...
            Label {
                ...
                readonly property bool showsTitleText: plasmoid.configuration.style === 1 || plasmoid.configuration.style === 3 //TitleApplication
                readonly property bool showsApplicationText: plasmoid.configuration.style === 0 || plasmoid.configuration.style === 2 //ApplicationTitle
                ...
                elide: {
                    if (plasmoid.configuration.style === 1 && titleLayout.exceedsAvailableSpace)
                        //Title
                        return Text.ElideMiddle;
                    else if (plasmoid.configuration.style === 3 && activeTaskItem && activeTaskItem.appName !== activeTaskItem.title && titleLayout.exceedsAvailableSpace)
                        //TitleApplication
                        return Text.ElideMiddle;
            ...
            Label {
                ...
                text: {
                    ...
                    if (plasmoid.configuration.style === 2 || plasmoid.configuration.style === 3) {
                        //ApplicationTitle
            ...
            Label {
                ...
                elide: {
                    if (activeTaskItem && activeTaskItem.appName !== activeTaskItem.title && plasmoid.configuration.style === 2 && titleLayout.exceedsAvailableSpace)
                        //ApplicationTitle
                        //AND is shown
                        return Text.ElideMiddle;
                    else if (plasmoid.configuration.style === 3)
